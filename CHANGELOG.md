...
### [1.1.2](https://github.com/rabelo-digital/ds-rd/compare/v1.1.1...v1.1.2) (2026-06-26)

### Bug Fixes

- **build:** emit scoped CSS module class maps via esbuild `local-css`; add `./styles.css` export
- **card:** stop clipping scrollable table/content inside Card body
